...
from search import RetrievalModel
...
class Dummy:
    pass
model_path = "E:/neulabdocprompting-codet5-python-doc-retriever"
class CodeT5Retriever:
    ...
    def retrieve(source_embed_file, target_embed_file, source_id_file, target_id_file, top_k, save_file):
        ...
        with open(source_id_file, "r", encoding='utf-8') as f:
            source_id_map = {}
        ...
        for source_idx, (dist, retrieved_index) in enumerate(zip(D, I)):
            ...
            # results[source_id]['retrieved'] = retrieved_index
...
def config(in_program_call=None):
    ...
    parser.add_argument('--source_file', default='input_intent.id')
    parser.add_argument('--target_file', default='code_intent.id')
    parser.add_argument('--source_embed_save_file', default="E:/shujukexue/src_embedding.jsonl")
    parser.add_argument('--target_embed_save_file', default="E:/shujukexue/tgt_embedding.jsonl")
    parser.add_argument('--save_file', default='output_search.jsonl')
